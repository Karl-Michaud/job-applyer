...
import { AddManualApplicationModal } from "./components/AddManualApplicationModal";
...
export function AppliedView() {
  const {
    ...
    updateStage, moveSelected, addManual,
  } = useAppliedViewModel();
      ...
      <div className="flex items-center justify-between">
        ...
        {selectedCount === 0 && (
          <button
            ...
            className="rounded-md border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 py-1.5 text-sm text-zinc-500 dark:text-zinc-400 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors"
          >
            + Add manually
          </button>
        )}
